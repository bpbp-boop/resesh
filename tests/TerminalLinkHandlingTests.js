...
assert(host.includes("Uri.UriSchemeHttp || uri.Scheme == Uri.UriSchemeHttps"), "link handling should allow only HTTP(S)");
assert(host.includes("UseShellExecute = true"), "link handling should use the Windows default browser");
